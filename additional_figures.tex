...
%% ============================================================
%% SECTION 2: Uniform distribution on the unit sphere
%% ============================================================
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.65\textwidth]{sphere_convergence.png}
...
%% ============================================================
%% SECTION 3: Downstream classification experiments
%% ============================================================
...
\caption{\textbf{End-to-end error convergence versus number of keys per query $n$.}
  BigBird-RoBERTa-base fine-tuned for $3$ epochs with mean pooling on the
  arxiv-classification task (11 categories, dense accuracy $86.4\%$).
  RMSE ($\beta=0.27$, $R^2=0.999$), pooling error ($\beta=0.30$, $R^2=1.000$)
  and logit error ($\beta=0.37$, $R^2=0.999$) all follow a sub-parametric
  power-law regime $n^{-\beta}$ with $\beta < \tfrac{1}{2}$, consistent with
  Theorem~5.3.}
...
\caption{\textbf{Normalized error rates versus $n$.}
  RMSE ($\beta=0.27$), pooling error ($\beta=0.30$), logit error ($\beta=0.37$)
  and disagreement rate with the dense model ($\beta=0.46$) all exhibit
  sub-parametric convergence, with downstream metrics converging more rapidly
  than embedding-level metrics. Shaded bands show $\pm 3$ standard-error
  intervals.}
...
%% ============================================================
%% SECTION 4: Windowed (non-i.i.d.) sampling experiments
%% ============================================================
