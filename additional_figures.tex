...
\caption{\textbf{Convergence rate $|\beta|$ versus horizon $H$ across
  ...
  $n \in [1000, 3000]$ i.i.d.\ sampled keys and $k = 500$ Monte Carlo
...
\caption{\textbf{Convergence curves for starred layers.}
  ...
  Markers show the averaged $\ell_2$ errors over $k=500$ subsamples,
...
\caption{\textbf{End-to-end error convergence versus number of keys per query $n$.}
  ...
  arxiv-classification task (11 categories, dense accuracy $86.4\%$), where
  $n$ i.i.d.\ sampled keys per query are used to compute attention at each layer.
