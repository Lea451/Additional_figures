...
\caption{\textbf{Effective rank $\mathrm{tr}(\Sigma)/\lambda_{\max}(\Sigma)$ of
  ...
  The effective rank decreases with depth across all datasets, indicative of
  increasing spectral concentration in deeper layers.
  Chinese Wikipedia exhibits markedly lower effective rank at every layer
  ($\sim\!3$--$6$ vs.\ $\sim\!5$--$27$ for the other datasets), reflecting its
  higher anisotropy.
  English Wikipedia and English news overlap closely throughout all layers,
  suggesting that effective rank might be primarily language-dependent rather than
  domain-dependent.}
