...
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{plots/BERT_slope_vs_H_stars_mean.pdf}
    \caption{Mean error}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{plots/BERT_slope_vs_H_stars_covariance.pdf}
...
\centering
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{plots/BERT_convergence_stars_mean.pdf}
    \caption{Mean error}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{plots/BERT_convergence_stars_covariance.pdf}
    \caption{Covariance error}
\end{subfigure}
...
\centering
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{plots/Window_RMSE_slope_vs_H.pdf}
    \caption{RMSE error}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{plots/Window_COV_slope_vs_H.pdf}
    \caption{Covariance error}
\end{subfigure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.65\textwidth]{plots/sphere_convergence.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.65\textwidth]{plots/downstream_task_end_to_end_errors.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.65\textwidth]{plots/downstream_task_classification_errors.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.65\textwidth]{plots/downstream_task_accuracy_agreement.pdf}
...
%% ============================================================
%% SECTION 5: Effective rank of the token covariance matrix
%% ============================================================

\section{Effective rank of the token covariance matrix per layer}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.65\textwidth]{plots/effective_rank_per_layer.pdf}
\caption{\textbf{Effective rank $\mathrm{tr}(\Sigma)/\lambda_{\max}(\Sigma)$ of
  the token covariance matrix at each layer of BigBird-RoBERTa-base, across
  four corpora.}
  The effective rank is evaluated on English Wikipedia, Chinese Wikipedia,
  German Wikipedia, and English news (CC-News), using the same pretrained model
  weights; differences arise solely from the input distribution.
  The effective rank decreases with depth across all datasets, reflecting
  increasing spectral concentration in deeper layers---consistent with the
  growing influence of $\lambda_{\max}(\Sigma)$ on the convergence constant in
  Theorem~5.3.
  Chinese Wikipedia exhibits markedly lower effective rank at every layer
  ($\sim\!3$--$6$ vs.\ $\sim\!5$--$27$ for the other corpora), reflecting its
  higher anisotropy and explaining the faster empirical slow-down observed for
  this distribution.
  English Wikipedia and English news overlap closely throughout all layers,
  suggesting that effective rank is primarily language-dependent rather than
  domain-dependent.}
